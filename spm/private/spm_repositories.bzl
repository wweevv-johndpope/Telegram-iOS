...
def _generate_bazel_pkg(
    ...
    print("✅:",json.encode_indent(pkg_desc)) # buildifier: disable=print
...
def _spm_repositories_impl(repository_ctx):
    ...
    print("repository_ctx:",repository_ctx) # buildifier: disable=print
    print("pkgs:",pkgs) # buildifier: disable=print
    print("env:",env) # buildifier: disable=print
